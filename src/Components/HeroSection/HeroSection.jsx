...
function HeroSection() {
  ...
  const discription = ["Watch live stream of the ICC Men's Cricket World Cup 2023 match between NewZealand and Australia","NEW EPISODE EVERY THURSDAY. Karan Johar brews a heady koffee in Season 8. Hosting glamourous A-listers, the chat digs deeper with more grounded&nbsp;conversations.","Cars on the Road follows Lightning McQueen and his best friend Mater as they head east on a cross-country road trip to meet up with Mater’s sister.","Dug Days is a new collection of shorts that follows the humorous misadventures of Dug, the lovable dog from Disney and Pixar’s Up.","NEW EPISODE EVERY FRIDAY AT 6:30 AM. The mercurial villain Loki resumes his role as the God of Mischief in a new series that takes place after the events of “Avengers: Endgame."]
  ...
  return (
    <div
      ...
      style={{ backgroundImage: `linear-gradient( to right, #000 10%, transparent 78% ),url(${background[imageIndex]})`}}
    >
